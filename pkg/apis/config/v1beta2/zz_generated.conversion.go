...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*GravityArgs)(nil), (*config.GravityArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GravityArgs_To_config_GravityArgs(a.(*GravityArgs), b.(*config.GravityArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GravityArgs)(nil), (*GravityArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GravityArgs_To_v1beta2_GravityArgs(a.(*config.GravityArgs), b.(*GravityArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*GravityWebhookConfig)(nil), (*config.GravityWebhookConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta2_GravityWebhookConfig_To_config_GravityWebhookConfig(a.(*GravityWebhookConfig), b.(*config.GravityWebhookConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.GravityWebhookConfig)(nil), (*GravityWebhookConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_GravityWebhookConfig_To_v1beta2_GravityWebhookConfig(a.(*config.GravityWebhookConfig), b.(*GravityWebhookConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta2_GravityArgs_To_config_GravityArgs(in *GravityArgs, out *config.GravityArgs, s conversion.Scope) error {
...
// Convert_v1beta2_GravityArgs_To_config_GravityArgs is an autogenerated conversion function.
func Convert_v1beta2_GravityArgs_To_config_GravityArgs(in *GravityArgs, out *config.GravityArgs, s conversion.Scope) error {
	return autoConvert_v1beta2_GravityArgs_To_config_GravityArgs(in, out, s)
}

func autoConvert_config_GravityArgs_To_v1beta2_GravityArgs(in *config.GravityArgs, out *GravityArgs, s conversion.Scope) error {
...
// Convert_config_GravityArgs_To_v1beta2_GravityArgs is an autogenerated conversion function.
func Convert_config_GravityArgs_To_v1beta2_GravityArgs(in *config.GravityArgs, out *GravityArgs, s conversion.Scope) error {
	return autoConvert_config_GravityArgs_To_v1beta2_GravityArgs(in, out, s)
}

func autoConvert_v1beta2_GravityWebhookConfig_To_config_GravityWebhookConfig(in *GravityWebhookConfig, out *config.GravityWebhookConfig, s conversion.Scope) error {
	if err := v1.Convert_Pointer_int64_To_int64(&in.Port, &out.Port, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.CertDir, &out.CertDir, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.CertName, &out.CertName, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.KeyName, &out.KeyName, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1beta2_GravityWebhookConfig_To_config_GravityWebhookConfig is an autogenerated conversion function.
func Convert_v1beta2_GravityWebhookConfig_To_config_GravityWebhookConfig(in *GravityWebhookConfig, out *config.GravityWebhookConfig, s conversion.Scope) error {
	return autoConvert_v1beta2_GravityWebhookConfig_To_config_GravityWebhookConfig(in, out, s)
}

func autoConvert_config_GravityWebhookConfig_To_v1beta2_GravityWebhookConfig(in *config.GravityWebhookConfig, out *GravityWebhookConfig, s conversion.Scope) error {
	if err := v1.Convert_int64_To_Pointer_int64(&in.Port, &out.Port, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.CertDir, &out.CertDir, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.CertName, &out.CertName, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.KeyName, &out.KeyName, s); err != nil {
		return err
	}
	return nil
}

// Convert_config_GravityWebhookConfig_To_v1beta2_GravityWebhookConfig is an autogenerated conversion function.
func Convert_config_GravityWebhookConfig_To_v1beta2_GravityWebhookConfig(in *config.GravityWebhookConfig, out *GravityWebhookConfig, s conversion.Scope) error {
	return autoConvert_config_GravityWebhookConfig_To_v1beta2_GravityWebhookConfig(in, out, s)
}
